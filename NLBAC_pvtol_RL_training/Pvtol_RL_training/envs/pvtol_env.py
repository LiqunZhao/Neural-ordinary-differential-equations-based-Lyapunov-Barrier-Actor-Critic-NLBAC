...
class PvtolEnv(gym.Env):
    ...
    def step(self, action):
        ...
        state, reward,constraint, lya_pre_term, done, info = self._step(action)
        return self.get_obs(), reward,constraint, lya_pre_term,self.get_obs(), done, info
    ...
    def _step(self, action):
        ...
        return self.state, reward,constraint,lya_pre_term, done, info
