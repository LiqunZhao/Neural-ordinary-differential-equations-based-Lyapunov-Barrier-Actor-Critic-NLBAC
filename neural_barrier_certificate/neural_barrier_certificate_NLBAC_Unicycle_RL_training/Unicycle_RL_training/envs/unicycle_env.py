...
class UnicycleEnv(gym.Env):
    ...
    def step(self, action):
        ...
        """
        state, reward, constraint,barrier_signal,center_pos,next_center_pos, done, info = self._step(action)
        return self.get_obs(), reward, constraint,barrier_signal,center_pos,next_center_pos, done, info
    ...
    def _step(self, action):
        ...
        return self.state, reward,constraint,barrier_signal,center_pos,next_center_pos, done, info
